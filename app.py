...
if st.session_state["confirmed_owner_property"] is None:
    ...
    st.markdown('<div class="card">', unsafe_allow_html=True)
    st.markdown('<p class="section-label" style="color:#22c55e;">📄 DOCUMENTATION</p><h3 style="color:#fff;">Download Professional Report</h3>', unsafe_allow_html=True)
    try:
        ...
        st.warning("Professional PDF module coming soon.")
    st.markdown('</div>', unsafe_allow_html=True)

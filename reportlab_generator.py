...
McKinsey/Deloitte style - Professional Tables, Charts, Layouts
"""
...
class CorporatePDF(FPDF):
    ...
    def header(self):
        # Corporate header with double line
...
def generer_rapport(property_data):
    ...
    metrics = [
        ('Current Value', f'€{current_val:,}', 'Pre-renovation'),
        ('Renovation Cost', f'€{cost:,}', 'Estimated investment'),
        ('Subsidy', f'€{subsidy:,}', 'MaPrimeRénov\''),
        ('Future Value', f'€{future_val:,}', 'Post-renovation'),
        ('Net Investment', f'€{net:,}', 'After subsidies'),
    ...
    pdf.set_font('Helvetica', 'B', 13)
    pdf.set_text_color(34, 197, 94)
    pdf.cell(0, 8, f'Estimated Net Gain After Renovation: +€{gain:,}', ln=True, align='C')
    ...
    data = [
        ...
        ['Surface Area', f'{int(surface)} m²', 'Standard'],
        ...
        ['Energy Consumption', 'Estimated 250-350 kWh/m²/year', 'High' if dpe in ['F','G'] else 'Moderate'],
    ]
    ...
    score_data = [
        ['Energy Performance', f'{energy_score}/100', 'Based on DPE rating', 'Critical'],
    ...
    financial_data = [
        ...
        ['Government Subsidies', f'+{subsidy:,}', 'MaPrimeRénov\''],
    ...
    if dpe in ['F', 'G']:
        roadmap = [
            ['1', 'Energy Audit', 'Week 1', '€500-1,000', 'Mandatory first step'],
            ['2', 'Wall Insulation', 'Week 2-4', '€12,000-18,000', 'Highest ROI (25-30%)'],
            ['3', 'Attic Insulation', 'Week 4-5', '€8,000-12,000', 'Second priority (20-25%)'],
            ['4', 'Heating System', 'Week 6-8', '€10,000-15,000', 'Major energy saving (30-35%)'],
            ['5', 'Final Audit', 'Week 9', '€500-1,000', 'Validate DPE improvement'],
        ]
    elif dpe == 'E':
        roadmap = [
            ['1', 'Heating Upgrade', 'Week 1-3', '€10,000-15,000', 'Primary energy saving'],
            ['2', 'Window Replacement', 'Week 3-5', '€8,000-12,000', 'Secondary priority'],
            ['3', 'Ventilation', 'Week 5-6', '€4,000-7,000', 'Air quality improvement'],
        ]
    else:
        roadmap = [
            ['1', 'Heating Optimization', 'Week 1', '€500-2,000', 'Quick win'],
            ['2', 'Window Upgrade', 'Week 2-3', '€6,000-10,000', 'Moderate ROI'],
            ['3', 'Solar Assessment', 'Week 3-4', '€500', 'Future planning'],
        ]
    
    pdf.corporate_table(['Priority', 'Action', 'Timeline', 'Cost Range', 'Impact'], roadmap, [15, 55, 30, 35, 45])
    ...
    risk_data = [
        ['Rental Ban Risk (2025)', 'High' if dpe in ['F','G'] else 'Low', dpe in ['F','G'] and 'Action Required' or 'Compliant'],
    ...
    next_steps = [
        ...
        '2. Submit MaPrimeRénov\' application (estimated timeline: 4-6 weeks)',

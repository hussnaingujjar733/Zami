...
def show():
    st.markdown("<h2 style='text-align: center; color: #D4AF37;'>🔐 Panneau d'Administration</h2>", unsafe_allow_html=True)
    ...
    with tab_art:
        ...
        try:
            ...
            st.error(f"Erreur chargement artisans: {e}")
